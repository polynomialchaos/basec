...
int main()
{
    ...
    BM_SET_PARAMETER("section/bool/scalar/bool", LogicalParameter,
                     &log_value, NULL, NULL, 0);
    BM_SET_PARAMETER("section/bool/scalar/bool_desc", LogicalParameter,
                     &log_value, "Description", NULL, 0);
    BM_SET_PARAMETER("section/bool/scalar/bool_desc_opt", LogicalParameter,
                     &log_value, "Description with options", &log_value, 1);

    bool_t log_values[] = {BC_TRUE, BC_FALSE, BC_TRUE, BC_TRUE};
    BM_SET_PARAMETER_N("section/bool/vector/bool", LogicalParameter,
                       log_values, 4, NULL, NULL, 0);
    BM_SET_PARAMETER_N("section/bool/vector/bool_desc", LogicalParameter,
                       log_values, 4, "Description", NULL, 0);
    BM_SET_PARAMETER_N("section/bool/vector/bool_desc_opt", LogicalParameter,
                       log_values, 4, "Description with options",
                       log_values, 4);

    /* digit type */
    int dig_value = 1;
    BM_SET_PARAMETER("section/digit/scalar/digit", DigitParameter,
                     &dig_value, NULL, NULL, 0);
    BM_SET_PARAMETER("section/digit/scalar/digit_desc", DigitParameter,
                     &dig_value, "Description", NULL, 0);
    BM_SET_PARAMETER("section/digit/scalar/digit_desc_opt", DigitParameter,
                     &dig_value, "Description with options", &dig_value, 1);

    int dig_values[] = {-1, 2, 30, 5};
    BM_SET_PARAMETER_N("section/digit/vector/digit", DigitParameter,
                       dig_values, 4, NULL, NULL, 0);
    BM_SET_PARAMETER_N("section/digit/vector/digit_desc", DigitParameter,
                       dig_values, 4, "Description", NULL, 0);
    BM_SET_PARAMETER_N("section/digit/vector/digit_desc_opt", DigitParameter,
                       dig_values, 4, "Description with options",
                       dig_values, 4);

    /* number type */
    double num_value = 1;
    BM_SET_PARAMETER("section/number/scalar/number", NumberParameter,
                     &num_value, NULL, NULL, 0);
    BM_SET_PARAMETER("section/number/scalar/number_desc", NumberParameter,
                     &num_value, "Description", NULL, 0);
    BM_SET_PARAMETER("section/number/scalar/number_desc_opt", NumberParameter,
                     &num_value, "Description with options", &num_value, 1);

    double num_values[] = {-1, 2, 30, 5};
    BM_SET_PARAMETER_N("section/number/vector/number", NumberParameter,
                       num_values, 4, NULL, NULL, 0);
    BM_SET_PARAMETER_N("section/number/vector/number_desc", NumberParameter,
                       num_values, 4, "Description", NULL, 0);
    BM_SET_PARAMETER_N("section/number/vector/number_desc_opt", NumberParameter,
                       num_values, 4, "Description with options",
                       num_values, 4);

    /* string type */
    string_t str_value = "String";
    BM_SET_PARAMETER("section/string/scalar/string", StringParameter,
                     &str_value, NULL, NULL, 0);
    BM_SET_PARAMETER("section/string/scalar/string_desc", StringParameter,
                     &str_value, "Description", NULL, 0);
    BM_SET_PARAMETER("section/string/scalar/string_desc_opt", StringParameter,
                     &str_value, "Description with options", &str_value, 1);

    string_t str_values[] = {"String 1", "String 2", "String 3", "String 4"};
    BM_SET_PARAMETER_N("section/string/vector/string", StringParameter,
                       str_values, 4, NULL, NULL, 0);
    BM_SET_PARAMETER_N("section/string/vector/string_desc", StringParameter,
                       str_values, 4, "Description", NULL, 0);
    BM_SET_PARAMETER_N("section/string/vector/string_desc_opt", StringParameter,
                       str_values, 4, "Description with options",
                       str_values, 4);
