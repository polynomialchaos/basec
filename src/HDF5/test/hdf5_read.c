...
int main(int argc, string_t *argv)
{
    ...
    BM_CHECK_EXPRESSION(exists_hdf5_group(file_id, group_name) == BC_TRUE);
    ...
    hsize_t dim = 4;
    int *vec_int_attr = BM_ALLOCATE(sizeof(int) * dim);
    double *vec_dbl_attr = BM_ALLOCATE(sizeof(double) * dim);
    string_t *vec_str_attr = NULL;

    BM_GET_HDF5_ATTRIBUTE_N(group_id, "vec_int_attr",
                            HDF5Int, dim, vec_int_attr);
    BM_CHECK_EXPRESSION(vec_int_attr[0] == 144);
    BM_CHECK_EXPRESSION(vec_int_attr[1] == 101);
    BM_CHECK_EXPRESSION(vec_int_attr[2] == 1);
    BM_CHECK_EXPRESSION(vec_int_attr[3] == 12);

    BM_GET_HDF5_ATTRIBUTE_N(group_id, "vec_dbl_attr",
    ...
    BM_CHECK_EXPRESSION(is_equal(vec_str_attr[3], "be"));

    BM_DEALLOCATE(vec_int_attr);
    BM_DEALLOCATE(vec_dbl_attr);
    deallocate_hdf5_string_buffer(vec_str_attr);
    BM_DEALLOCATE(vec_str_attr);

    close_hdf5_group(group_id);

    /* vector dataset */
    vec_int_attr = BM_ALLOCATE(sizeof(int) * dim);
    vec_dbl_attr = BM_ALLOCATE(sizeof(double) * dim);
    vec_str_attr = NULL;
    BM_GET_HDF5_DATASET_N(file_id, "vec_int_dset", HDF5Int, dim, vec_int_attr);
    BM_CHECK_EXPRESSION(vec_int_attr[0] == 144);
    BM_CHECK_EXPRESSION(vec_int_attr[1] == 101);
    BM_CHECK_EXPRESSION(vec_int_attr[2] == 1);
    BM_CHECK_EXPRESSION(vec_int_attr[3] == 12);
    ...
    hsize_t count = dim;
    vec_int_attr = BM_ALLOCATE(sizeof(int) * dim);
    BM_GET_HDF5_DATASET_CHUNK_N(file_id, "vec_int_dset_off", HDF5Int,
                                dim, 1, &dim_glob,
    ...
    hsize_t stride = 2;
    vec_int_attr = BM_ALLOCATE(sizeof(int) * dim);
    BM_GET_HDF5_DATASET_CHUNK_N(file_id, "vec_int_dset_str", HDF5Int,
                                dim, 1, &dim_glob,
    ...
    hsize_t block = 2;
    vec_int_attr = BM_ALLOCATE(sizeof(int) * dim);
    BM_GET_HDF5_DATASET_CHUNK_N(file_id, "vec_int_dset_blk", HDF5Int,
                                dim, 1, &dim_glob,
    ...
    vec_int_attr = BM_ALLOCATE(sizeof(int) * dim);
    BM_GET_HDF5_DATASET_SELECT_N(file_id, "vec_int_dset_hps", HDF5Int,
                                 dim, dim_glob,
    ...
    BM_DEALLOCATE(arr_dbl_dset);

    /* array dataset + offset/count/stride/block */
    hsize_t dim_arr_glob[] = {20, 20};
    hsize_t offset_arr[] = {4, 4};
    hsize_t count_arr[] = {4, 6};
    arr_dbl_dset = BM_ALLOCATE(sizeof(double) * dim_arr[0] * dim_arr[1]);
    BM_GET_HDF5_DATASET_CHUNK_N_M(file_id, "arr_dbl_dset_off", HDF5Double,
    ...
    vec_dbl_attr = BM_ALLOCATE(sizeof(double) * dim);
    BM_GET_HDF5_DATASET_CHUNK_N(file_id, "arr_dbl_dset_off", HDF5Double,
                                dim, 2, dim_arr_glob,
    ...
    arr_dbl_dset = BM_ALLOCATE(sizeof(double) * dim_arr[0] * dim_arr[1]);
    BM_GET_HDF5_DATASET_CHUNK_N_M(file_id, "arr_dbl_dset_str", HDF5Double,
                                  dim_arr, 2, dim_arr_glob,
    ...
    arr_dbl_dset = BM_ALLOCATE(sizeof(double) * dim_arr[0] * dim_arr[1]);
    BM_GET_HDF5_DATASET_CHUNK_N_M(file_id, "arr_dbl_dset_blk", HDF5Double,
                                  dim_arr, 2, dim_arr_glob,
    ...
    arr_dbl_dset = BM_ALLOCATE(sizeof(double) * dim_arr[0] * dim_arr[1]);
    BM_GET_HDF5_DATASET_SELECT_N_M(file_id, "arr_dbl_dset_hps", HDF5Double,
